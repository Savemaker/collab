...
int			print_access(t_dir *object, char *buf, t_row_tty *row_struct, int i)
{
//	int	i;
	acl_t acl;
...
int print_link(t_dir *object, char *buf, int i)
{
	char link[1024];
	ssize_t ret;
	char *pointer;
...
int			print_name(t_dir *object, char *buf, int i)
{
//	int i;
	int c;
...
int			print_size(long int size, char *buf, long int max_len, int i)
{
//	int i;
	long int len;
...
int			print_major_minor(long int size, char *buf, long int max_len, uint16_t major, int i)
{
